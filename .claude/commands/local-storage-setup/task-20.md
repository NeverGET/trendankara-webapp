# local-storage-setup - Task 20

Execute task 20 for the local-storage-setup specification.

## Task Description
Create media upload API endpoint

## Code Reuse
**Leverage existing code**: src/lib/storage/upload.ts, src/lib/storage/multer.ts, src/lib/db/queries/media.ts
...
## Usage
```
/Task:20-local-storage-setup
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create media upload API endpoint"

```
Use the @spec-task-executor agent to implement task 20: "Create media upload API endpoint" for the local-storage-setup specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create media upload API endpoint
- Leverage: src/lib/storage/upload.ts, src/lib/storage/multer.ts, src/lib/db/queries/media.ts
- Requirements: 2.3, 4.1, 4.4

## Instructions
- Implement ONLY task 20: "Create media upload API endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks local-storage-setup 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks local-storage-setup 20 --mode complete
```
