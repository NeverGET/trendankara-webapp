# admin-ui-design - Task 17

Execute task 17 for the admin-ui-design specification.
...
## Usage
```
/Task:17-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create useMediaUpload hook"

```
Use the @spec-task-executor agent to implement task 17: "Create useMediaUpload hook" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: Create useMediaUpload hook
- Leverage: src/lib/storage/client.ts
- Requirements: 5.3, 5.5

## Instructions
- Implement ONLY task 17: "Create useMediaUpload hook"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 17 --mode complete
```
