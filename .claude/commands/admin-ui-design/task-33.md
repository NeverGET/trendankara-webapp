# admin-ui-design - Task 33

Execute task 33 for the admin-ui-design specification.

## Task Description
Add error boundaries to admin pages

## Code Reuse
**Leverage existing code**: Next.js error boundary pattern
...
## Usage
```
/Task:33-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add error boundaries to admin pages"

```
Use the @spec-task-executor agent to implement task 33: "Add error boundaries to admin pages" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 33
- Description: Add error boundaries to admin pages
- Leverage: Next.js error boundary pattern
- Requirements: 1.3

## Instructions
- Implement ONLY task 33: "Add error boundaries to admin pages"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 33 --mode complete
```
