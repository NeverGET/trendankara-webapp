# admin-ui-design - Task 32

Execute task 32 for the admin-ui-design specification.

## Task Description
Add loading skeletons to dashboard

## Code Reuse
**Leverage existing code**: existing Tailwind animation classes
...
## Usage
```
/Task:32-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add loading skeletons to dashboard"

```
Use the @spec-task-executor agent to implement task 32: "Add loading skeletons to dashboard" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 32
- Description: Add loading skeletons to dashboard
- Leverage: existing Tailwind animation classes
- Requirements: 1.1

## Instructions
- Implement ONLY task 32: "Add loading skeletons to dashboard"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 32 --mode complete
```
