# admin-ui-design - Task 16

Execute task 16 for the admin-ui-design specification.
...
## Usage
```
/Task:16-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create UploadProgressBar component"

```
Use the @spec-task-executor agent to implement task 16: "Create UploadProgressBar component" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 16
- Description: Create UploadProgressBar component
- Leverage: existing Tailwind classes
- Requirements: 5.3

## Instructions
- Implement ONLY task 16: "Create UploadProgressBar component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 16 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 16 --mode complete
```
