# admin-ui-design - Task 14

Execute task 14 for the admin-ui-design specification.

## Task Description
Create media delete API route

## Code Reuse
**Leverage existing code**: src/lib/storage/client.ts, src/lib/auth/utils.ts
...
## Usage
```
/Task:14-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create media delete API route"

```
Use the @spec-task-executor agent to implement task 14: "Create media delete API route" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Create media delete API route
- Leverage: src/lib/storage/client.ts, src/lib/auth/utils.ts
- Requirements: 6.1, 6.2

## Instructions
- Implement ONLY task 14: "Create media delete API route"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 14 --mode complete
```
