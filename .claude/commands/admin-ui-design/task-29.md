# admin-ui-design - Task 29

Execute task 29 for the admin-ui-design specification.

## Task Description
Add image usage check before deletion
...
## Usage
```
/Task:29-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add image usage check before deletion"

```
Use the @spec-task-executor agent to implement task 29: "Add image usage check before deletion" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 29
- Description: Add image usage check before deletion
- Leverage: src/lib/db/client.ts
- Requirements: 6.4

## Instructions
- Implement ONLY task 29: "Add image usage check before deletion"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 29 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 29 --mode complete
```
