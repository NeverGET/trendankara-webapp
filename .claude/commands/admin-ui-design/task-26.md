# admin-ui-design - Task 26

Execute task 26 for the admin-ui-design specification.

## Task Description
Add bulk selection to media gallery

## Code Reuse
**Leverage existing code**: existing component structure
...
## Usage
```
/Task:26-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add bulk selection to media gallery"

```
Use the @spec-task-executor agent to implement task 26: "Add bulk selection to media gallery" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 26
- Description: Add bulk selection to media gallery
- Leverage: existing component structure
- Requirements: 6.3

## Instructions
- Implement ONLY task 26: "Add bulk selection to media gallery"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 26 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 26 --mode complete
```
