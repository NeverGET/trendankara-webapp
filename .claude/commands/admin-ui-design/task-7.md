# admin-ui-design - Task 7

Execute task 7 for the admin-ui-design specification.

## Task Description
Create PasswordChangeForm component

## Code Reuse
**Leverage existing code**: src/components/ui/Input.tsx, src/components/ui/Button.tsx
...
## Usage
```
/Task:7-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create PasswordChangeForm component"

```
Use the @spec-task-executor agent to implement task 7: "Create PasswordChangeForm component" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Create PasswordChangeForm component
- Leverage: src/components/ui/Input.tsx, src/components/ui/Button.tsx
- Requirements: 3.1, 3.2

## Instructions
- Implement ONLY task 7: "Create PasswordChangeForm component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 7 --mode complete
```
