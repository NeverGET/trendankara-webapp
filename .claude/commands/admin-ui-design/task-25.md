# admin-ui-design - Task 25

Execute task 25 for the admin-ui-design specification.

## Task Description
Integrate notifications in admin layout

## Code Reuse
**Leverage existing code**: src/contexts/NotificationContext.tsx
...
## Usage
```
/Task:25-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Integrate notifications in admin layout"

```
Use the @spec-task-executor agent to implement task 25: "Integrate notifications in admin layout" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Integrate notifications in admin layout
- Leverage: src/contexts/NotificationContext.tsx
- Requirements: 1.3

## Instructions
- Implement ONLY task 25: "Integrate notifications in admin layout"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 25 --mode complete
```
