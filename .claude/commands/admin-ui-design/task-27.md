# admin-ui-design - Task 27

Execute task 27 for the admin-ui-design specification.
...
## Usage
```
/Task:27-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create BulkActionBar component"

```
Use the @spec-task-executor agent to implement task 27: "Create BulkActionBar component" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 27
- Description: Create BulkActionBar component
- Leverage: src/components/ui/Button.tsx
- Requirements: 6.3

## Instructions
- Implement ONLY task 27: "Create BulkActionBar component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 27 --mode complete
```
