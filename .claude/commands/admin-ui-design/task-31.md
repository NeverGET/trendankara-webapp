# admin-ui-design - Task 31

Execute task 31 for the admin-ui-design specification.

## Task Description
Apply translations to admin components

## Code Reuse
**Leverage existing code**: src/lib/translations/admin.ts
...
## Usage
```
/Task:31-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Apply translations to admin components"

```
Use the @spec-task-executor agent to implement task 31: "Apply translations to admin components" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: Apply translations to admin components
- Leverage: src/lib/translations/admin.ts
- Requirements: 4.1, 4.2

## Instructions
- Implement ONLY task 31: "Apply translations to admin components"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 31 --mode complete
```
