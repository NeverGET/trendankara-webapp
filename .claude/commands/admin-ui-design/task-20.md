# admin-ui-design - Task 20

Execute task 20 for the admin-ui-design specification.

## Task Description
Add pagination to media gallery

## Code Reuse
**Leverage existing code**: src/components/ui/Button.tsx
...
## Usage
```
/Task:20-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add pagination to media gallery"

```
Use the @spec-task-executor agent to implement task 20: "Add pagination to media gallery" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Add pagination to media gallery
- Leverage: src/components/ui/Button.tsx
- Requirements: 4.5

## Instructions
- Implement ONLY task 20: "Add pagination to media gallery"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 20 --mode complete
```
