# admin-ui-design - Task 8

Execute task 8 for the admin-ui-design specification.

## Task Description
Create password change API route

## Code Reuse
**Leverage existing code**: src/lib/auth/utils.ts, src/lib/auth/password.ts
...
## Usage
```
/Task:8-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create password change API route"

```
Use the @spec-task-executor agent to implement task 8: "Create password change API route" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: Create password change API route
- Leverage: src/lib/auth/utils.ts, src/lib/auth/password.ts
- Requirements: 3.3, 3.4

## Instructions
- Implement ONLY task 8: "Create password change API route"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 8 --mode complete
```
