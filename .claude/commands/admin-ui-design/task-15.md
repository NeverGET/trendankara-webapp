# admin-ui-design - Task 15

Execute task 15 for the admin-ui-design specification.
...
## Usage
```
/Task:15-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create ImageUploadZone component"

```
Use the @spec-task-executor agent to implement task 15: "Create ImageUploadZone component" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: Create ImageUploadZone component
- Leverage: src/components/ui/Button.tsx
- Requirements: 5.1, 5.2

## Instructions
- Implement ONLY task 15: "Create ImageUploadZone component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 15 --mode complete
```
