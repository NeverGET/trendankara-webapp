# admin-ui-design - Task 30

Execute task 30 for the admin-ui-design specification.

## Task Description
Add Turkish language strings

## Code Reuse
**Leverage existing code**: new file
...
## Usage
```
/Task:30-admin-ui-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add Turkish language strings"

```
Use the @spec-task-executor agent to implement task 30: "Add Turkish language strings" for the admin-ui-design specification and include all the below context.
...
## Task Details
- Task ID: 30
- Description: Add Turkish language strings
- Leverage: new file
- Requirements: 4.1, 4.2

## Instructions
- Implement ONLY task 30: "Add Turkish language strings"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-ui-design 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-ui-design 30 --mode complete
```
