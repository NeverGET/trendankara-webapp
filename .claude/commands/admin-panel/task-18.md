...
Execute task 18 for the admin-panel specification.

## Task Description
Create media usage checker
...
Execute with @spec-task-executor agent the following task: "Create media usage checker"

```
Use the @spec-task-executor agent to implement task 18: "Create media usage checker" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Create media usage checker
- Leverage: src/lib/db/client.ts
- Requirements: 3.4

## Instructions
- Implement ONLY task 18: "Create media usage checker"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 18 --mode complete
```
