...
Execute task 30 for the admin-panel specification.
...
Execute with @spec-task-executor agent the following task: "Create user form component"

```
Use the @spec-task-executor agent to implement task 30: "Create user form component" for the admin-panel specification and include all the below context.
...
## Instructions
- Implement ONLY task 30: "Create user form component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 30 --mode complete
```
