...
Execute task 29 for the admin-panel specification.

## Task Description
Create user management API routes

## Code Reuse
**Leverage existing code**: src/lib/auth/utils.ts for role checking
...
Execute with @spec-task-executor agent the following task: "Create user management API routes"

```
Use the @spec-task-executor agent to implement task 29: "Create user management API routes" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 29
- Description: Create user management API routes
- Leverage: src/lib/auth/utils.ts for role checking
- Requirements: 5.1, 5.3

## Instructions
- Implement ONLY task 29: "Create user management API routes"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 29 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 29 --mode complete
```
