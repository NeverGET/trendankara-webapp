...
Execute task 23 for the admin-panel specification.

## Task Description
Create component palette for builder

## Code Reuse
**Leverage existing code**: Existing ContentEditor component
...
Execute with @spec-task-executor agent the following task: "Create component palette for builder"

```
Use the @spec-task-executor agent to implement task 23: "Create component palette for builder" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Create component palette for builder
- Leverage: Existing ContentEditor component
- Requirements: 4.1

## Instructions
- Implement ONLY task 23: "Create component palette for builder"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 23 --mode complete
```
