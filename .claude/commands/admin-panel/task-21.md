...
Execute task 21 for the admin-panel specification.

## Task Description
Create content page database functions
...
Execute with @spec-task-executor agent the following task: "Create content page database functions"

```
Use the @spec-task-executor agent to implement task 21: "Create content page database functions" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Create content page database functions
- Leverage: src/lib/db/client.ts
- Requirements: 4.3

## Instructions
- Implement ONLY task 21: "Create content page database functions"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 21 --mode complete
```
