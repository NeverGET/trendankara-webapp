...
Execute task 31 for the admin-panel specification.
...
Execute with @spec-task-executor agent the following task: "Create password change modal"

```
Use the @spec-task-executor agent to implement task 31: "Create password change modal" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: Create password change modal
- Leverage: src/components/ui/Modal.tsx
- Requirements: 5.4

## Instructions
- Implement ONLY task 31: "Create password change modal"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 31 --mode complete
```
