...
Execute task 46 for the admin-panel specification.

## Task Description
Add CSRF protection to forms

## Code Reuse
**Leverage existing code**: crypto for token generation
...
Execute with @spec-task-executor agent the following task: "Add CSRF protection to forms"

```
Use the @spec-task-executor agent to implement task 46: "Add CSRF protection to forms" for the admin-panel specification and include all the below context.
...
- Leverage: crypto for token generation
- Requirements: NFR-Security

## Instructions
- Implement ONLY task 46: "Add CSRF protection to forms"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 46 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 46 --mode complete
```
