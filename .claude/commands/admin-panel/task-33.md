...
Execute task 33 for the admin-panel specification.

## Task Description
Create settings database functions
...
Execute with @spec-task-executor agent the following task: "Create settings database functions"

```
Use the @spec-task-executor agent to implement task 33: "Create settings database functions" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 33
- Description: Create settings database functions
- Leverage: src/lib/db/client.ts
- Requirements: 6.1

## Instructions
- Implement ONLY task 33: "Create settings database functions"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 33 --mode complete
```
