...
Execute task 19 for the admin-panel specification.

## Task Description
Create media picker dialog component

## Code Reuse
**Leverage existing code**: src/components/ui/Modal.tsx
...
Execute with @spec-task-executor agent the following task: "Create media picker dialog component"

```
Use the @spec-task-executor agent to implement task 19: "Create media picker dialog component" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 19
- Description: Create media picker dialog component
- Leverage: src/components/ui/Modal.tsx
- Requirements: 3.3

## Instructions
- Implement ONLY task 19: "Create media picker dialog component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 19 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 19 --mode complete
```
