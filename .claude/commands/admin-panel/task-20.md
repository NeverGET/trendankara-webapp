...
Execute task 20 for the admin-panel specification.

## Task Description
Update media page with enhanced features

## Code Reuse
**Leverage existing code**: Existing MediaManager component
...
Execute with @spec-task-executor agent the following task: "Update media page with enhanced features"

```
Use the @spec-task-executor agent to implement task 20: "Update media page with enhanced features" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Update media page with enhanced features
- Leverage: Existing MediaManager component
- Requirements: 3.2, 3.6

## Instructions
- Implement ONLY task 20: "Update media page with enhanced features"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 20 --mode complete
```
