...
Execute task 22 for the admin-panel specification.

## Task Description
Create content builder API routes
...
Execute with @spec-task-executor agent the following task: "Create content builder API routes"

```
Use the @spec-task-executor agent to implement task 22: "Create content builder API routes" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Create content builder API routes
- Leverage: src/lib/db/content-pages.ts
- Requirements: 4.3, 4.5

## Instructions
- Implement ONLY task 22: "Create content builder API routes"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 22 --mode complete
```
