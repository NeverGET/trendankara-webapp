...
Execute task 37 for the admin-panel specification.

## Task Description
Update settings page with forms

## Code Reuse
**Leverage existing code**: Existing page structure
...
Execute with @spec-task-executor agent the following task: "Update settings page with forms"

```
Use the @spec-task-executor agent to implement task 37: "Update settings page with forms" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 37
- Description: Update settings page with forms
- Leverage: Existing page structure
- Requirements: 6.1, 6.4

## Instructions
- Implement ONLY task 37: "Update settings page with forms"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 37 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 37 --mode complete
```
