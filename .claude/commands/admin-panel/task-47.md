...
Execute task 47 for the admin-panel specification.

## Task Description
Add Turkish translations file

## Code Reuse
**Leverage existing code**: JSX string interpolation
...
Execute with @spec-task-executor agent the following task: "Add Turkish translations file"

```
Use the @spec-task-executor agent to implement task 47: "Add Turkish translations file" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 47
- Description: Add Turkish translations file
- Leverage: JSX string interpolation
- Requirements: NFR-Usability

## Instructions
- Implement ONLY task 47: "Add Turkish translations file"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 47 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 47 --mode complete
```
