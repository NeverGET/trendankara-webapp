...
Execute task 36 for the admin-panel specification.

## Task Description
Create maintenance mode component
...
Execute with @spec-task-executor agent the following task: "Create maintenance mode component"

```
Use the @spec-task-executor agent to implement task 36: "Create maintenance mode component" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 36
- Description: Create maintenance mode component
- Leverage: src/components/ui/Button.tsx
- Requirements: 6.3

## Instructions
- Implement ONLY task 36: "Create maintenance mode component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 36 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 36 --mode complete
```
