...
Execute task 40 for the admin-panel specification.

## Task Description
Update dashboard stats API

## Code Reuse
**Leverage existing code**: src/lib/cache/stats-cache.ts
...
Execute with @spec-task-executor agent the following task: "Update dashboard stats API"

```
Use the @spec-task-executor agent to implement task 40: "Update dashboard stats API" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 40
- Description: Update dashboard stats API
- Leverage: src/lib/cache/stats-cache.ts
- Requirements: 7.1, 7.3

## Instructions
- Implement ONLY task 40: "Update dashboard stats API"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 40 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 40 --mode complete
```
