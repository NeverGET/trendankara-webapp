...
Execute task 38 for the admin-panel specification.
...
Execute with @spec-task-executor agent the following task: "Create dashboard statistics queries"

```
Use the @spec-task-executor agent to implement task 38: "Create dashboard statistics queries" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 38
- Description: Create dashboard statistics queries
- Leverage: src/lib/db/client.ts
- Requirements: 7.2

## Instructions
- Implement ONLY task 38: "Create dashboard statistics queries"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 38 --mode complete
```
