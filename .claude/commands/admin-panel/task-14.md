...
Execute task 14 for the admin-panel specification.

## Task Description
Create poll items management component

## Code Reuse
**Leverage existing code**: src/components/ui/Button.tsx, MediaPicker
...
Execute with @spec-task-executor agent the following task: "Create poll items management component"

```
Use the @spec-task-executor agent to implement task 14: "Create poll items management component" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Create poll items management component
- Leverage: src/components/ui/Button.tsx, MediaPicker
- Requirements: 2.2

## Instructions
- Implement ONLY task 14: "Create poll items management component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 14 --mode complete
```
