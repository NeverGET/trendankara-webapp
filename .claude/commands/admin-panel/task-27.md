...
Execute task 27 for the admin-panel specification.

## Task Description
Create user management database functions

## Code Reuse
**Leverage existing code**: src/lib/db/auth.ts patterns
...
Execute with @spec-task-executor agent the following task: "Create user management database functions"

```
Use the @spec-task-executor agent to implement task 27: "Create user management database functions" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 27
- Description: Create user management database functions
- Leverage: src/lib/db/auth.ts patterns
- Requirements: 5.1, 5.2

## Instructions
- Implement ONLY task 27: "Create user management database functions"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 27 --mode complete
```
