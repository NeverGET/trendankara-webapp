...
Execute task 44 for the admin-panel specification.

## Task Description
Create audit middleware

## Code Reuse
**Leverage existing code**: Next.js middleware patterns

## Requirements Reference
**Requirements**: NFR-Reliability
...
Execute with @spec-task-executor agent the following task: "Create audit middleware"

```
Use the @spec-task-executor agent to implement task 44: "Create audit middleware" for the admin-panel specification and include all the below context.
...
## Task Details
- Task ID: 44
- Description: Create audit middleware
- Leverage: Next.js middleware patterns
- Requirements: NFR-Reliability

## Instructions
- Implement ONLY task 44: "Create audit middleware"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks admin-panel 44 --mode complete
...
```bash
claude-code-spec-workflow get-tasks admin-panel 44 --mode complete
```
