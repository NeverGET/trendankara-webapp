# frontend-design - Task 47

Execute task 47 for the frontend-design specification.

## Task Description
Create MediaPicker dialog component in src/components/media/MediaPicker.tsx

## Code Reuse
**Leverage existing code**: Modal component, /api/media endpoint
...
## Usage
```
/Task:47-frontend-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create MediaPicker dialog component in src/components/media/MediaPicker.tsx"

```
Use the @spec-task-executor agent to implement task 47: "Create MediaPicker dialog component in src/components/media/MediaPicker.tsx" for the frontend-design specification and include all the below context.
...
## Task Details
- Task ID: 47
- Description: Create MediaPicker dialog component in src/components/media/MediaPicker.tsx
- Leverage: Modal component, /api/media endpoint
- Requirements: 10.4

## Instructions
- Implement ONLY task 47: "Create MediaPicker dialog component in src/components/media/MediaPicker.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-design 47 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-design 47 --mode complete
```
