# frontend-design - Task 30

Execute task 30 for the frontend-design specification.

## Task Description
Add auto-play to NewsCarousel in src/components/news/NewsCarousel.tsx

## Code Reuse
**Leverage existing code**: useEffect, setInterval
...
## Usage
```
/Task:30-frontend-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add auto-play to NewsCarousel in src/components/news/NewsCarousel.tsx"

```
Use the @spec-task-executor agent to implement task 30: "Add auto-play to NewsCarousel in src/components/news/NewsCarousel.tsx" for the frontend-design specification and include all the below context.
...
## Task Details
- Task ID: 30
- Description: Add auto-play to NewsCarousel in src/components/news/NewsCarousel.tsx
- Leverage: useEffect, setInterval
- Requirements: 3.1

## Instructions
- Implement ONLY task 30: "Add auto-play to NewsCarousel in src/components/news/NewsCarousel.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-design 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-design 30 --mode complete
```
