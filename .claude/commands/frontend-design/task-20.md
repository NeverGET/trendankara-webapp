# frontend-design - Task 20

Execute task 20 for the frontend-design specification.

## Task Description
Create PlayerControls component in src/components/radio/PlayerControls.tsx

## Code Reuse
**Leverage existing code**: RadioPlayerContext, Button component
...
## Usage
```
/Task:20-frontend-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create PlayerControls component in src/components/radio/PlayerControls.tsx"

```
Use the @spec-task-executor agent to implement task 20: "Create PlayerControls component in src/components/radio/PlayerControls.tsx" for the frontend-design specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create PlayerControls component in src/components/radio/PlayerControls.tsx
- Leverage: RadioPlayerContext, Button component
- Requirements: 2.3, 2.4

## Instructions
- Implement ONLY task 20: "Create PlayerControls component in src/components/radio/PlayerControls.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-design 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-design 20 --mode complete
```
