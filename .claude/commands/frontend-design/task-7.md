# frontend-design - Task 7

Execute task 7 for the frontend-design specification.

## Task Description
Create Header component with navigation in src/components/common/Header.tsx

## Code Reuse
**Leverage existing code**: existing Layout.tsx patterns, brand colors
...
## Usage
```
/Task:7-frontend-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Header component with navigation in src/components/common/Header.tsx"

```
Use the @spec-task-executor agent to implement task 7: "Create Header component with navigation in src/components/common/Header.tsx" for the frontend-design specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Create Header component with navigation in src/components/common/Header.tsx
- Leverage: existing Layout.tsx patterns, brand colors
- Requirements: 5.1, 5.2, 5.3

## Instructions
- Implement ONLY task 7: "Create Header component with navigation in src/components/common/Header.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-design 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-design 7 --mode complete
```
