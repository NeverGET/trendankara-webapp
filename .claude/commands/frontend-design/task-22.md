# frontend-design - Task 22

Execute task 22 for the frontend-design specification.

## Task Description
Create BottomRadioPlayer for mobile in src/components/radio/BottomRadioPlayer.tsx

## Code Reuse
**Leverage existing code**: RadioPlayer components, useRadioPlayer
...
## Usage
```
/Task:22-frontend-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create BottomRadioPlayer for mobile in src/components/radio/BottomRadioPlayer.tsx"

```
Use the @spec-task-executor agent to implement task 22: "Create BottomRadioPlayer for mobile in src/components/radio/BottomRadioPlayer.tsx" for the frontend-design specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Create BottomRadioPlayer for mobile in src/components/radio/BottomRadioPlayer.tsx
- Leverage: RadioPlayer components, useRadioPlayer
- Requirements: 2.6, 7.1

## Instructions
- Implement ONLY task 22: "Create BottomRadioPlayer for mobile in src/components/radio/BottomRadioPlayer.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-design 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-design 22 --mode complete
```
