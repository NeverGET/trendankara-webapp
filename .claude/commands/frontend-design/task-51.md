# frontend-design - Task 51

Execute task 51 for the frontend-design specification.

## Task Description
Add responsive utilities in src/lib/hooks/useMediaQuery.ts

## Code Reuse
**Leverage existing code**: window.matchMedia API
...
## Usage
```
/Task:51-frontend-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add responsive utilities in src/lib/hooks/useMediaQuery.ts"

```
Use the @spec-task-executor agent to implement task 51: "Add responsive utilities in src/lib/hooks/useMediaQuery.ts" for the frontend-design specification and include all the below context.
...
## Task Details
- Task ID: 51
- Description: Add responsive utilities in src/lib/hooks/useMediaQuery.ts
- Leverage: window.matchMedia API
- Requirements: 7.1, 7.2, 7.3

## Instructions
- Implement ONLY task 51: "Add responsive utilities in src/lib/hooks/useMediaQuery.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-design 51 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-design 51 --mode complete
```
