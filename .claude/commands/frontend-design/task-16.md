# frontend-design - Task 16

Execute task 16 for the frontend-design specification.

## Task Description
Implement nuclear reset method in IOSAudioManager

## Code Reuse
**Leverage existing code**: AudioContext API
...
## Usage
```
/Task:16-frontend-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement nuclear reset method in IOSAudioManager"

```
Use the @spec-task-executor agent to implement task 16: "Implement nuclear reset method in IOSAudioManager" for the frontend-design specification and include all the below context.
...
## Task Details
- Task ID: 16
- Description: Implement nuclear reset method in IOSAudioManager
- Leverage: AudioContext API
- Requirements: 2.5

## Instructions
- Implement ONLY task 16: "Implement nuclear reset method in IOSAudioManager"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-design 16 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-design 16 --mode complete
```
