# frontend-design - Task 24

Execute task 24 for the frontend-design specification.

## Task Description
Create NewsCard component in src/components/news/NewsCard.tsx

## Code Reuse
**Leverage existing code**: Card component, Next/Image
...
## Usage
```
/Task:24-frontend-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create NewsCard component in src/components/news/NewsCard.tsx"

```
Use the @spec-task-executor agent to implement task 24: "Create NewsCard component in src/components/news/NewsCard.tsx" for the frontend-design specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: Create NewsCard component in src/components/news/NewsCard.tsx
- Leverage: Card component, Next/Image
- Requirements: 3.4, 3.5, 3.6

## Instructions
- Implement ONLY task 24: "Create NewsCard component in src/components/news/NewsCard.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-design 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-design 24 --mode complete
```
