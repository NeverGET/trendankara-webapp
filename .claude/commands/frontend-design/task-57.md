# frontend-design - Task 57

Execute task 57 for the frontend-design specification.

## Task Description
Add prefers-reduced-motion support in src/app/globals.css

## Code Reuse
**Leverage existing code**: existing globals.css
...
## Usage
```
/Task:57-frontend-design
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add prefers-reduced-motion support in src/app/globals.css"

```
Use the @spec-task-executor agent to implement task 57: "Add prefers-reduced-motion support in src/app/globals.css" for the frontend-design specification and include all the below context.
...
## Task Details
- Task ID: 57
- Description: Add prefers-reduced-motion support in src/app/globals.css
- Leverage: existing globals.css
- Requirements: 9.5

## Instructions
- Implement ONLY task 57: "Add prefers-reduced-motion support in src/app/globals.css"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks frontend-design 57 --mode complete
...
```bash
claude-code-spec-workflow get-tasks frontend-design 57 --mode complete
```
