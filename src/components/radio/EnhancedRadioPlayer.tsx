    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20 gap-4">
          ...
          {/* Simple Now Playing Badge */}
          <div className="flex-1 max-w-2xl">
            <div className="flex items-center justify-center gap-3">
              {/* Sound Bars - Always reserve space */}
              ...
              <div className={`px-4 py-2 rounded-full font-medium text-sm truncate shadow-lg ${
                isPlaying
                  ...
                  : 'bg-slate-500 text-slate-100 shadow-slate-500/20'
              }`}>
                {currentSong}
              </div>
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:flex items-center gap-2">
              <input
                ...
                className="w-24 h-2 bg-gray-600 rounded-lg appearance-none cursor-pointer slider [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:bg-red-600 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:cursor-pointer [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:bg-red-600 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-0 [&::-moz-range-thumb]:cursor-pointer"
