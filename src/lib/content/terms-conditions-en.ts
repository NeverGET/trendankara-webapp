...
• Application means the software program provided by the Company downloaded by You on any electronic device, named TrendAnkara
...
• Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SÜPER ŞOV GAZETE RADYO TELEVİZYON YAY.SANAYİ VE TİC. A.Ş., operating TrendAnkara radio station.
...
Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy of the Company. Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal information when You use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our Privacy Policy carefully before using Our Service.`,
    },
    {
      ...
      content: `Radio Streaming

The Service provides live radio streaming of TrendAnkara radio station. The availability and quality of the stream may vary based on Your internet connection and geographic location.
...
• Reproduce, distribute, or publicly display any content from the Service without permission
• Use the Service in any manner that could disable, overburden, or impair the Service`,
    },
    {
      id: 'intellectual-property',
      title: 'Intellectual Property',
      content: `The Service and its original content (excluding user-generated content), features and functionality are and will remain the exclusive property of the Company and its licensors. The Service is protected by copyright, trademark, and other laws of both Turkey and foreign countries.

Music and content broadcast through the radio stream are the property of their respective copyright holders. The Company holds the necessary licenses for broadcasting such content.`,
    },
    {
      id: 'links',
...
These Terms and Conditions are governed by and construed in accordance with the laws of Turkey. Any disputes arising from these Terms shall be subject to the exclusive jurisdiction of the courts of Ankara, Turkey.`,
    },
    {
      id: 'disputes',
...
• By email: pasa.akbuga@gmail.com
• By visiting this page on our website: https://trendankara.com/
• By phone: 0312 279 11 10
• By mail: ERYAMAN MAH. 2. CAD. NO :19 ETİMESGUT / ANKARA, Turkey`,
    },
  ],
};
